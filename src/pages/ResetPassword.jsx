    ...
    <div className='relative w-screen h-dvh p-2 grid grid-cols-1 lg:grid-cols-[1fr,1.2fr] lg:gap-2'>
      <div className='flex flex-col p-4'>
        ...
        <div className="flex flex-col gap-2 max-w-[480px] w-full mx-auto">
          ...
          <p className="text-bodyLarge text-light-onSurfaceVariant dark:text-dark-onSurfaceVariant mt-1 mb-5 text-center px-2">Please choose a new password, it must have at least 8 characters.</p>

          <Form method='POST' className='grid grid-cols-1 gap-4'>
          <TextField type="password" name="password" placeholder=" " label={"Password"} required = {true} autoFocus = {true} />
          <Button type = "submit" disabled={navigation.state === 'submitting'}> {navigation.state === 'submitting' ? <CircularProgress size='small' /> : 'Reset Password'}</Button>
          </Form>
